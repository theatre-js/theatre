...
const SNAP_RANGE = 10
export const PanelWidthChannel = 'TheatreJS/PanelWidthChannel'
export const PanelActiveModeChannel = 'TheatreJS/PanelActiveModeChannel'

export default class Panel extends PureComponentWithTheatre<IProps, IState> {
