...
describe('DataVerse.atoms.dict', () => {
  ...
  it('should correctly report deep changes', () => {
    ...
    expect(deepChanges[5]).toMatchObject({overriddenRefs: {}, deletedKeys: ['obj']})
  })
  ...
  it('should correctly report deep diffs', () => {
    ...
    expect(deepDiffs[5]).toMatchObject({deepUnboxOfOldRefs: {foo: 'foo2'}, deletedKeys: ['foo']})
  })
})