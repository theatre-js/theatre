...
describe('AbstractDerivedDict', () => {
  ...
  function typeTests() {
    ...
    o1DD.prop('obj').getValue() as AbstractDerivedDict<{
      objFoo: BoxAtom<string>
    }>
    o1DD.prop('obj').getValue() as AbstractDerivedDict<{
      objFoo: BoxAtom<number>
    }>

    o1DD
      .pointer()
      .prop('obj')
      .getValue() as AbstractDerivedDict<{objFoo: BoxAtom<string>}>
    o1DD
      .pointer()
      .prop('obj')
      .getValue() as AbstractDerivedDict<{objFoo: BoxAtom<number>}>
    ...
    o1eo2DD.prop('obj').getValue() as AbstractDerivedDict<{
      objFoo: BoxAtom<string>
    }>
    o1eo2DD.prop('obj').getValue() as AbstractDerivedDict<{
      objFoo: BoxAtom<number>
