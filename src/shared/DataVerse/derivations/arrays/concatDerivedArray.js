...
export class ConcatenatedDerivedArray<V> extends AbstractDerivedArray implements IDerivedArray<V> {
...
export default function concatDerivedArray<V>(left: IDerivedArray<V>, right: IDerivedArray<V>): IDerivedArray<V> {
