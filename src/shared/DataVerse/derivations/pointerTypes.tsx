...
export type IndexOfPointer<O> = {
  '1':
  O extends ArrayAtom<infer T> ? PointerDerivation<T> :
  PointerDerivation<void>
}[O extends number ? '1' : '1']

export type PropOfPointer<O, K> = {
  '1':
  O extends DictAtom<infer T> ? PointerDerivation<K extends keyof T ? T[K] : void> :
  O extends AbstractDerivedDict<infer OO> ? PointerDerivation<K extends keyof OO ? PropOfADD<OO[K]> : void> :
  PointerDerivation<void>
}[O extends number ? '1' : '1']
