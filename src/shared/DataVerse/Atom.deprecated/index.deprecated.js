...
export interface Atom {
  __isAtom: true,
  __setParent(parent: Atom): void,
}

export type DeprecatedAtom<T = void> = any
...
export const withSubscribables = <S: {[key: mixed]: Subscribable<any>}>(fn: (props: $FixMe) => S): HigherOrderComponent<{}, $ObjMap<S, Identity>> => {
  return (null: any)
}
